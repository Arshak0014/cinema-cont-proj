    ...
    <?php foreach ($data['products'] as $product):?>
        <div id="counted" style="margin-bottom: 20px;margin-right: 5px" class="card">
            <a href="/product/details/<?=$product['id']; ?>">
                <img style="width:248px;height: 248px" src="../../../assets/images/<?= $product['image'] ?>" alt="">
            </a>
...
<div align="left" style="margin: 13px 25px 33px 62px;">
    <?php
    $categories_id = Router::getSegment('2');

    $pagination = new \application\components\Pagination('/category/'.$categories_id.'/page/','products','9','9');

    $pagination->html('where categories_id = '.$categories_id);
